...
public class Templates extends Vocabulary {
	...
	// Classes
	public static final Resource Template = getProperty(ns + "Template");
	public static final Resource TemplateInstance = getProperty(ns + "TemplateInstance");
	
	// Individuals
	public static final Resource incomplete = getProperty(ns + "incomplete");
